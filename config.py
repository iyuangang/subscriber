...
SRC_EMAIL = "hhyg20@gmail.com"  #Your gmail account for sending mail to Kindle
DOMAIN = "https://ikindleyg.appspot.com" #Your domain of app
...
MY_FEEDS_TITLE = u'Subscriber by iYG'
MY_FEEDS_DESC = u'RSS delivering from Subscriber'
